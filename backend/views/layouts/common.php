            ...
            <?php echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        ...
                        'items' => [
                            ['label' => Yii::t('backend', 'Category'), 'url' => ['/game-category/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Game'), 'url' => ['/game/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Game Type'), 'url' => ['/game-type/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                            ['label' => Yii::t('backend', 'Terms'), 'url' => ['/game-terms/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
                        ]
                    ],
                    [
